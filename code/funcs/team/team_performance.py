...
def create_performance_plot(master_df, result_all_stats_df, subcategory, last_round):
    if subcategory == "Ball Possession":
        ...
        plot_boxplot(
            ...
            x="stat_value",
            y="team_name",
            title=f"{st.session_state['selected_league_original']} {st.session_state['selected_season_original']} Season – Ball Possession per Team",
        ...
        plot_stacked_bar_chart(
            ...
            title=f"{st.session_state['selected_league_original']} {st.session_state['selected_season_original']} Season – Passing Accuracy per Team",
        ...
        plot_stacked_horizontal_bar(
            ...
            title=f"{st.session_state['selected_league_original']} {st.session_state['selected_season_original']} Season – Big Chance Conversion Rate per Team",
        ...
        plot_stacked_horizontal_bar(
            ...
            title=f"{st.session_state['selected_league_original']} {st.session_state['selected_season_original']} Season – Shooting Accuracy per Team",
        ...
        plot_stacked_horizontal_bar(
            ...
            stat_columns=shooting_categories,
            total_column="Total shots",
            title=f"{st.session_state['selected_league_original']} {st.session_state['selected_season_original']} Season – Shot Preference by Penalty Area per Team",
            xlabel="Number of Shots",
            ylabel="",
            colors={
        ...
        plot_horizontal_bar(
            ...
            x="stat_value",
            y="team_name",
            title=f"{st.session_state['selected_league_original']} {st.session_state['selected_season_original']} Season – Touches in the Penalty Area per Team",
        ...
        plot_horizontal_bar(
            ...
            x="stat_value",
            y="team_name",
            title=f"{st.session_state['selected_league_original']} {st.session_state['selected_season_original']} Season – Entries into the Final Third per Team",
        ...
        plot_stacked_horizontal_bar(
            ...
            title=f"{st.session_state['selected_league_original']} {st.session_state['selected_season_original']} Season – Final Third Action Efficiency per Team",
        ...
        plot_horizontal_bar(
            ...
            x="Foul Difference",
            y="team",
            title=f"{st.session_state['selected_league_original']} {st.session_state['selected_season_original']} Season – Difference Between Fouls Committed and Fouls Suffered per Team",
        ...
        plot_horizontal_bar(
            ...
            x="Cards per Foul",
            y="team_name",
            title=f"{st.session_state['selected_league_original']} {st.session_state['selected_season_original']} Season – Number of Cards (Yellow and Red) per Foul Committed per Team",
        ...
        plot_stacked_horizontal_bar(
            ...
            title=f"{st.session_state['selected_league_original']} {st.session_state['selected_season_original']} Season – Successful and Unsuccessful Long Pass Rate per Team",
        ...
        plot_stacked_horizontal_bar(
            ...
            title=f"{st.session_state['selected_league_original']} {st.session_state['selected_season_original']} Season – Successful and Unsuccessful Cross Rate per Team",
